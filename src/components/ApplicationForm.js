...
const ApplicationForm = ({ user, mobile }) => {
  const [formData, setFormData] = useState({
    ...
    toDate: new Date().toISOString().split('T')[0],
    permanentAddress: '', // Added permanent address field
    deliveryMethod: '' // Added delivery method field
  });
  const [profileData, setProfileData] = useState(null);
  const [files, setFiles] = useState({
    nic: null,
    ...
    try {
      ...
      if (uploadResponse.data.success) {
        ...
        const applicationData = {
          ...
          toDate,
          permanentAddress, // Include permanent address in application data
          deliveryMethod: formData.deliveryMethod // Include delivery method
        };
    ...
    <div className="container">
      ...
      <div className="sidebar">
        ...
        <ul style={{listStyle: 'none', padding: 0}}>
          ...
          <li style={{padding: '8px 0'}}><a href="#" style={{textDecoration: 'none', color: '#333'}} onClick={() => navigate('/apply')}>📋 Apply for PCC</a></li>
          <li style={{padding: '8px 0'}}><a href="#" style={{textDecoration: 'none', color: '#333'}} onClick={() => navigate('/applications')}>📄 My Applications</a></li>
          <li style={{padding: '8px 0'}}><a href="#" style={{textDecoration: 'none', color: '#'}} onClick={() => navigate('/profile')}>👤 Profile</a></li>
          <li style={{padding: '8px 0'}}><a href="#" style={{textDecoration: 'none', color: '#333'}}>📞 Help & Contact</a></li>
        </ul>
      ...
      <div className="main-content clearfix">
        ...
        <div className="card" style={{background: 'linear-gradient(135deg, #f8f9fa 0%, #e8f4fd 100%)', marginBottom: '20px', borderLeft: '4px solid #3498db'}}>
          <h4>Instructions</h4>
          <p style={{marginTop: '10px'}}>
            Please fill all required fields (marked with *) and upload clear copies of your documents. 
            Applications with incomplete information will be rejected.
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* NEW: Certificate Delivery Option */}
          <h3>Certificate Delivery</h3>
          <div className="form-group">
            <label className="form-label">Certificate Delivery Method *</label>
            <div style={{marginTop: '10px'}}>
              <label style={{display: 'flex', alignItems: 'flex-start', cursor: 'pointer'}}>
                ...
                <span style={{lineHeight: '1.4'}}>
                  I need a physical hard copy certificate to be collected from the police station
                </span>
              </label>
              <p style={{fontSize: '13px', color: '#7f8c8d', marginTop: '8px', marginLeft: '28px'}}>
                Note: All applicants will receive a digital certificate. Physical certificates must be collected in person from the police station with valid identification.
              </p>
            </div>
          </div>
